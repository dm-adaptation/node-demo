...
!function(t) {
    ...
    function u(_, d) {
        return __awaiter(this, void 0, void 0, function() {
            var n, e, t, o, i, u, c, f, s, a;
            return __generator(this, function(r) {
                switch (r.label) {
                  case 0:
                    return e = _.getTrimString("svcConfPath", ""), [ 4, svcConf_1.SvcConf.load(e, !1) ];

                  case 1:
                    return n = r.sent(), t = _.getTrimString("addressRemap", "") || n.globalProperties.getTrimString("addressRemap", ""), 
                    d = p(d, t), o = __read([ "", "" ], 2), i = o[0], u = o[1], c = d.lastIndexOf(":"), 
                    u = -1 !== c ? (i = d.substring(0, c), d.substring(c + 1)) : (i = d, const_1.Const.PORT_DEFAULT.toString()), 
                    _.set("host", i), _.set("port", u), f = _.getTrimString("userRemap", "") || n.globalProperties.getTrimString("userRemap", ""), 
                    _.set("user", p(_.getTrimString("user", ""), f)), "" !== (a = _.getTrimString(d, "")) ? (a.startsWith("(") && a.endsWith(")") && (a = a.slice(1, a.length - 1)), 
                    s = svcConf_1.SvcConf.parseServerName(d, a)) : n.serverGroupMap.has(d) && (s = n.serverGroupMap.get(d)), 
                    s = s || new epGroup_1.EPGroup(i + ":" + u, [ new ep_1.EP(i, Number.parseInt(u)) ]), 
                    _.setDiffProps(s.props), _.getBoolean("rwSeparate", !1) && (_.setIfNotExist("loginMode", const_1.Const.LOGIN_MODE_PRIMARY_ONLY.toString()), 
                    _.setIfNotExist("loginStatus", const_1.Const.SERVER_STATUS_OPEN.toString()), _.setIfNotExist("doSwitch", "true")), 
                    _.setAny("epGroup", s), _.setDiffProps(n.globalProperties), [ 2, _ ];
                }
            });
        });
    }

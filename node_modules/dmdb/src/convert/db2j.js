...
var blob_1 = require("../driver/blob"), dbtype_1 = require("../driver/dbtype"), clob_1 = require("../driver/clob"), error_1 = require("../driver/error"), dateUtil_1 = require("../utils/dateUtil"), bufferUtil_1 = require("../utils/bufferUtil"), stringUtil_1 = require("../utils/stringUtil"), intervalDT_1 = require("../driver/intervalDT"), intervalYM_1 = require("../driver/intervalYM"), numeric_1 = require("../driver/numeric"), lob_1 = require("../driver/lob"), dm_1 = require("../dm"), DB2J = function() {
        ...
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(e) {
                switch (e.label) {
                  ...
                  case 6:
                    if (r = bufferUtil_1.BufferUtil.n(n, 0), void 0 === c) return dm_1.dmdb.fetchAsString.includes(dm_1.dmdb.NUMBER) ? [ 2, r.toString() ] : [ 2, Number(r) ];
                  ...
                  case 9:
                    return t = dateUtil_1.DateUtil.decode(n, u.isBdta, u.mask, i.conn_prop_localTimezone, i.dbTimezone), 
                    [ 4, a.toDate(n, u, i, t) ];

                  case 10:
                    return r = e.sent(), [ 2, a.fetchDateAsString(r, t, a.getFormatString(u, i), u.scale, i.oracleDateLanguage, c) ];
        ...
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    return c = c || dateUtil_1.DateUtil.decode(n, u.isBdta, u.mask, i.conn_prop_localTimezone, i.dbTimezone), 
    ...
    }, a.fetchDateAsString = function(e, r, t, n, u, i) {
        if (void 0 !== i) {
            if (i === dm_1.dmdb.STRING) return t ? dateUtil_1.DateUtil.toStringFromDT(r, t, n, u) : e.toUTCString();
        } else if (dm_1.dmdb.fetchAsString.includes(dm_1.dmdb.DATE)) return t ? dateUtil_1.DateUtil.toStringFromDT(r, t, n, u) : e.toUTCString();
        return e;

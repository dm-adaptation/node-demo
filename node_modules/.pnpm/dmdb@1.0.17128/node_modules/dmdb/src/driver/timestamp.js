...
var const_1 = require("../desc/const"), dbtype_1 = require("./dbtype"), column_1 = require("../desc/column"), connection_1 = require("./connection"), util_1 = require("util"), dateUtil_1 = require("../utils/dateUtil"), Timestamp = function(i) {
    function c(e, t, n) {
        ...
        if (r.dtype = dbtype_1.DBType.DATETIME, r.scale = 6, e instanceof Buffer && t instanceof column_1.Column && n instanceof connection_1.Connection) switch (r.dt = dateUtil_1.DateUtil.decode(e, t.isBdta, t.mask, n.conn_prop_localTimezone, n.dbTimezone), 
        ...
        (r = i.call(this, r.dt[c.OFFSET_YEAR], r.dt[c.OFFSET_MONTH], r.dt[c.OFFSET_DAY], r.dt[c.OFFSET_HOUR], r.dt[c.OFFSET_MINUTE], r.dt[c.OFFSET_SECOND], r.dt[c.OFFSET_NANOSECOND] / 1e6) || this).oracleDateLanguage = n.oracleDateLanguage, 
        t.type) {
          ...
          case dbtype_1.DBType.DATETIME2_TZ:
            ...
            r.dt = e, r.dtype = t, r.scale = n, r = i.call(this, e[c.OFFSET_YEAR], e[c.OFFSET_MONTH], e[c.OFFSET_DAY], e[c.OFFSET_HOUR], e[c.OFFSET_MINUTE], e[c.OFFSET_SECOND], e[c.OFFSET_NANOSECOND] / 1e6) || this;
        }
        return r;
    }
    ...
    c.OFFSET_SECOND = 5, c.OFFSET_NANOSECOND = 6, c.OFFSET_TIMEZONE = 7, c.DT_LEN = 8, 
    c.INVALID_VALUE = const_1.Const.INT32_MIN, c.NANOSECOND_DIGITS = 9, c.NANOSECOND_POW = 1e9, 
    c;
}(Date);

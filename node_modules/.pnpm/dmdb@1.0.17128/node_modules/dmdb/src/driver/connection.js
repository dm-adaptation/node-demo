...
var path_1 = require("path"), access_1 = require("../net/access"), error_1 = require("./error"), const_1 = require("../desc/const"), driverUtil_1 = require("../utils/driverUtil"), stringUtil_1 = require("../utils/stringUtil"), dm_1 = require("../dm"), lob_1 = require("./lob"), events_1 = require("events"), net_1 = require("net"), statement_1 = require("./statement"), tls_1 = require("tls"), fs_1 = require("fs"), os_1 = require("os"), svcConf_1 = require("../desc/svcConf"), middleware_1 = require("../middleware/middleware"), cacheQueue_1 = require("../utils/cacheQueue"), timer_1 = require("../utils/timer"), msg_1 = require("../net/msg/msg"), Connection = function(i) {
    function n(t) {
        ...
        n.conn_prop_logFlushFreq = 30, n.conn_prop_injectArray = !1, n.closed = !0, n.readOnly = !1, 
        n.local = !1, n.rwStandby = !1, n.props = t, n.setAttributes(t), 0 < n.conn_prop_stmtPoolSize && (n.stmtPool = new cacheQueue_1.CacheQueue(n.conn_prop_stmtPoolSize, !1), 
    ...
    return __extends(n, i), n.newInstanceOfConnection = function(t) {
            ...
            return __generator(this, function(t) {
                ...
                [ 2, new Promise(function(t, i) {
                    process.nextTick(function() {
                        n.socket ? (n.doUnbinds(n.socket), n.socket.destroyed ? t() : (n.socket.destroy(), 
                        n.socket.once("close", function() {
                            n.closed = !0, t();
        ...
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(t) {
                switch (t.label) {
                  ...
                  case 2:
                    for (c = t.sent(), r = 0; r < c.length; r++) dm_1.dmdb.isBindParameter(c[r]) || (c[r] = {
                  ...
                  case 7:
                    for (c = t.sent(), n = new Array(i.serverParams.length), r = 0; r < i.serverParams.length; r++) for (s in e = i.serverParams[r], 
                ...
                switch (t.label) {
                  ...
                  case 9:
                    for (t.sent(), n = 0; n < f.length; n++) if (r = f[n], Array.isArray(r)) {
                        ...
                        for (s = new Array(i.serverParams.length), o = 0; o < i.serverParams.length; o++) for (u in c = i.serverParams[o], 
        ...
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(t) {
                switch (t.label) {
                  ...
                  case 2:
                    return t.sent(), n = {}, 0 < i.serverParams.length && (n.bindNames = [], i.serverParams.forEach(function(t) {
        ...
        return i.setNoDelay(!0), i.setKeepAlive(!0), i.on("error", function(t) {
            n._handleNetWorkError(error_1.DBError.ECJS_COMMUNICATION_ERROR(t.message));
        }), i.on("end", function() {

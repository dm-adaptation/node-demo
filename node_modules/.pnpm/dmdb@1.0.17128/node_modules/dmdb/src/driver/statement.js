...
var __extends = this && this.__extends || function() {
...
}(), __awaiter = this && this.__awaiter || function(t, h, a, u) {
            ...
            return function(e) {
                ...
                for (;a; ) try {
                    ...
                    switch (n = 0, h && (e = [ 2 & e[0], h.value ]), e[0]) {
                      ...
                      default:
                        if (!(h = 0 < (h = a.trys).length && h[h.length - 1]) && (6 === e[0] || 2 === e[0])) {
                            a = 0;
                            continue;
                        }
                        ...
                        if (6 === e[0] && a.label < h[1]) {
                            a.label = h[1], h = e;
                            break;
                        }
                        if (h && a.label < h[2]) {
                            a.label = h[2], a.ops.push(e);
                            break;
                        }
    ...
    if (!r) return t;
    var i, s, n = r.call(t), h = [];
    try {
        for (;(void 0 === e || 0 < e--) && !(i = n.next()).done; ) h.push(i.value);
    } catch (t) {
        s = {
            error: t
        };
...
var executeRetInfo_1 = require("../desc/executeRetInfo"), error_1 = require("./error"), parameter_1 = require("../desc/parameter"), sqlProcessor_1 = require("../parser/sqlProcessor"), resultSet_1 = require("./resultSet"), dm_1 = require("../dm"), stmtInfo_1 = require("../desc/stmtInfo"), resultSetCachePool_1 = require("./resultSetCachePool"), dbtype_1 = require("./dbtype"), j2db_1 = require("../convert/j2db"), lob_1 = require("./lob"), db2j_1 = require("../convert/db2j"), stream_1 = require("stream"), const_1 = require("../desc/const"), Statement = function() {
    ...
    }, i.prototype.executeInner = function(a, u) {
        return __awaiter(this, void 0, void 0, function() {
            var e, r, i, s, n, h;
            return __generator(this, function(t) {
                switch (t.label) {
                  case 0:
                    if (!a) throw error_1.DBError.ECJS_SQL_IS_EMPTY();
                    if (this.nativeSql = a, this.escapeProcessing) try {
                        this.nativeSql = sqlProcessor_1.SQLProcessor.escape(a, this.connection.conn_prop_keyWords);
                    } catch (t) {}
                  ...
                  case 5:
                    ...
                    return this.nativeSql = a, [ 4, (n = this).connection.access.V(this, u) ];
                  ...
                  case 8:
                    return [ 4, (h = this).connection.access.V(this, u) ];
    ...
    function t(t, e, r) {
        ...
        return i.serverParams = new Array(0), i.bindParams = new Array(0), i.paramCount = 0, 
        i.rowIndex = 0, i.preExec = !1, i.type = Statement.PREPARED_STATEMENT, i.paramObjectsList = new Array(), 
        i.curRowObjects = new Array(i.paramCount), i;
    }
    return __extends(t, s), t.prototype.prepareSql = function(i, s) {
        return __awaiter(this, void 0, void 0, function() {
            var e, r;
            return __generator(this, function(t) {
                switch (t.label) {
                  case 0:
                    if (!i) throw error_1.DBError.ECJS_SQL_IS_EMPTY();
                    if (this.nativeSql = i, this.escapeProcessing) try {
                        this.nativeSql = sqlProcessor_1.SQLProcessor.escape(i, this.connection.conn_prop_keyWords);
                    } catch (t) {}
                    if (this.connection.conn_prop_injectArray && s) try {
                        r = __read(sqlProcessor_1.SQLProcessor.arrayConstant(i, s), 2), this.nativeSql = r[0], 
                        s = r[1];
                    } catch (t) {}
                    return [ 4, this.connection.access.X(this) ];

                  case 1:
                    return e = t.sent(), this.execInfo = e, [ 2, s ];
                }
            });
        });
    }, t.prototype.executePstmt = function(s) {
        return __awaiter(this, void 0, void 0, function() {
            var e, r, i;
            return __generator(this, function(t) {
                switch (t.label) {
                  case 0:
                    return [ 4, this._encodeArgs(s, !0) ];
    ...
    }, t.prototype.executeManyPstmt = function(c) {
        return __awaiter(this, void 0, void 0, function() {
            var e, r, i, s, n, h, a, u;
            return __generator(this, function(t) {
                switch (t.label) {
                  case 0:
                    if (e = new Array(c.length), !(0 < this.paramCount)) return [ 3, 4 ];
                    r = 0, t.label = 1;

                  case 1:
                    return r < c.length ? (i = c[r], s = e, n = r, [ 4, this._encodeArgs(i, 0 === r) ]) : [ 3, 4 ];
                  ...
                  case 6:
                    return 1 === e.length || 2 === this.connection.conn_prop_batchType || this.connection.conn_prop_batchNotOnCall && this.execInfo.retSqlType === const_1.Const.SQL_TYPE_DML_CALL ? [ 4, (a = this).connection.access.$(this, e, this.preExec) ] : [ 3, 8 ];

                  case 7:
                    return a.execInfo = t.sent(), [ 3, 10 ];

                  case 8:
                    return [ 4, (u = this).connection.access.tt(this, e, this.preExec) ];

                  case 9:
                    u.execInfo = t.sent(), t.label = 10;
    ...
    }, t.prototype._bindInParam = function(t, e, r) {
        var i, s, n;
        r && (i = e === dbtype_1.DBType.NULL, s = this.serverParams[t], n = this.bindParams[t], 
        s ? (n.name = s.name, n.typeDescriptor = s.typeDescriptor, n.mask = s.mask, n.typeFlag = s.typeFlag, 
        s.type != dbtype_1.DBType.UNKNOWN && (i || s.typeFlag === parameter_1.Parameter.TYPE_FLAG_EXACT) || 0 !== s.mask ? (n.type = s.type, 
        n.prec = s.prec, n.scale = s.scale, n.mask = s.mask) : n.resetType(e)) : n.resetType(e), 
        n.ioType = n.ioType === parameter_1.Parameter.IO_TYPE_OUT || n.ioType === parameter_1.Parameter.IO_TYPE_INOUT ? parameter_1.Parameter.IO_TYPE_INOUT : parameter_1.Parameter.IO_TYPE_IN);
    }, t.prototype._checkBindParameters = function(t) {
        for (var e = 0; e < this.paramCount; e++) {
            if (this.bindParams[e].ioType === parameter_1.Parameter.IO_TYPE_UNKNOWN) {
                if (!this.serverParams[e] || this.serverParams[e].ioType !== parameter_1.Parameter.IO_TYPE_OUT) throw error_1.DBError.ECJS_UNBINDED_PARAMETER();
                t[e] = null;
            }
            this.bindParams[e].type !== dbtype_1.DBType.CURSOR ? this.serverParams[e] && this.serverParams[e].ioType !== this.bindParams[e].ioType && (this.bindParams[e].ioType = this.serverParams[e].ioType) : this.bindParams[e].ioType = parameter_1.Parameter.IO_TYPE_INOUT;
        }
        for (e = 0; e < this.paramCount; e++) switch (this.bindParams[e].type) {
          case dbtype_1.DBType.CHAR:
          case dbtype_1.DBType.VARCHAR:
          case dbtype_1.DBType.VARCHAR2:
            var r = t[e] instanceof Buffer ? t[e].length : -1;
            if (r > dbtype_1.DBType.VARCHAR_PREC) throw error_1.DBError.ECJS_STRING_CUT();
            r > this.bindParams[e].prec && (r < dbtype_1.DBType.VARCHAR_PREC / 4 ? this.bindParams[e].prec = dbtype_1.DBType.VARCHAR_PREC / 4 : r < dbtype_1.DBType.VARCHAR_PREC / 2 ? this.bindParams[e].prec = dbtype_1.DBType.VARCHAR_PREC / 2 : r < 3 * dbtype_1.DBType.VARCHAR_PREC / 4 ? this.bindParams[e].prec = 3 * dbtype_1.DBType.VARCHAR_PREC / 4 : this.bindParams[e].prec = dbtype_1.DBType.VARCHAR_PREC);
        }
    }, t.prototype._encodeArgs = function(y, v) {
        return __awaiter(this, void 0, void 0, function() {
            var e, r, i, s, n, h, a, u, c, o, _, f, d, b;
            return __generator(this, function(t) {
                switch (t.label) {
                  case 0:
                    e = new Array(y.length), r = 0, t.label = 1;

                  case 1:
                    return r < this.serverParams.length ? (i = y[r], this.serverParams[r].type !== dbtype_1.DBType.CURSOR ? [ 3, 4 ] : (this._bindInParam(r, dbtype_1.DBType.CURSOR, v), 
                    this.bindParams[r].cursorStmt ? [ 3, 3 ] : (this.bindParams[r].cursorStmt = new Statement(this.connection, this.execOpts, !1), 
                    [ 4, this.bindParams[r].cursorStmt.allocateHandle() ]))) : [ 3, 24 ];

                  case 2:
                    t.sent(), t.label = 3;

                  case 3:
                    return this.bindParams[r].ioType = parameter_1.Parameter.IO_TYPE_INOUT, [ 3, 23 ];

                  case 4:
                    return null != i && void 0 !== i.val && null !== i.val ? [ 3, 5 ] : (this._bindInParam(r, dbtype_1.DBType.NULL, v), 
                    e[r] = null, [ 3, 23 ]);

                  case 5:
                    return "number" != typeof i.val ? [ 3, 6 ] : (Number.isNaN(i.val) || !Number.isFinite(i.val) ? (this._bindInParam(r, dbtype_1.DBType.NULL, v), 
                    e[r] = null) : (this._bindInParam(r, dbtype_1.DBType.DOUBLE, v), e[r] = j2db_1.J2DB.fromNumber(i.val, this.bindParams[r], this.connection)), 
                    [ 3, 23 ]);

                  case 6:
                    return "bigint" != typeof i.val ? [ 3, 7 ] : (this._bindInParam(r, dbtype_1.DBType.BIGINT, v), 
                    e[r] = j2db_1.J2DB.fromBigInt(i.val, this.bindParams[r], this.connection), [ 3, 23 ]);

                  case 7:
                    return "string" != typeof i.val ? [ 3, 11 ] : "" === i.val && dbtype_1.DBType.emptyStringToNull(this.serverParams[r].type) ? (this._bindInParam(r, dbtype_1.DBType.NULL, v), 
                    e[r] = null, [ 3, 10 ]) : [ 3, 8 ];

                  case 8:
                    return h = i.val.length >= dbtype_1.DBType.VARCHAR_PREC ? dbtype_1.DBType.CLOB : dbtype_1.DBType.VARCHAR, 
                    this._bindInParam(r, h, v), s = e, n = r, [ 4, j2db_1.J2DB.fromString(i.val, this.bindParams[r], this.connection) ];
                  ...
                  case 11:
                    return "boolean" != typeof i.val ? [ 3, 12 ] : (this._bindInParam(r, dbtype_1.DBType.TINYINT, v), 
                    e[r] = j2db_1.J2DB.fromBoolean(i.val, this.bindParams[r], this.connection), [ 3, 23 ]);

                  case 12:
                    return i.val instanceof Buffer ? (h = i.val.length >= dbtype_1.DBType.VARBINARY_PREC ? dbtype_1.DBType.BLOB : dbtype_1.DBType.VARBINARY, 
                    this._bindInParam(r, h, v), a = e, u = r, [ 4, j2db_1.J2DB.fromBuffer(i.val, this.bindParams[r], this.connection) ]) : [ 3, 14 ];

                  case 13:
                    return a[u] = t.sent(), [ 3, 23 ];

                  case 14:
                    return i.val instanceof lob_1.Lob ? i.val.type !== dm_1.dmdb.BLOB ? [ 3, 16 ] : (this._bindInParam(r, dbtype_1.DBType.BLOB, v), 
                    c = e, o = r, [ 4, j2db_1.J2DB.fromBlob(i.val.iLob, this.bindParams[r], this.connection) ]) : [ 3, 19 ];

                  case 15:
                    return c[o] = t.sent(), [ 3, 18 ];

                  case 16:
                    return this._bindInParam(r, dbtype_1.DBType.CLOB, v), _ = e, f = r, [ 4, j2db_1.J2DB.fromClob(i.val.iLob, this.bindParams[r], this.connection) ];

                  case 17:
                    _[f] = t.sent(), t.label = 18;

                  case 18:
                    return [ 3, 23 ];

                  case 19:
                    return i.val instanceof Date ? (this._bindInParam(r, dbtype_1.DBType.DATETIME, v), 
                    e[r] = j2db_1.J2DB.fromDate(i.val, this.bindParams[r], this.connection), [ 3, 23 ]) : [ 3, 20 ];

                  case 20:
                    return i.val instanceof stream_1.Readable ? (this._bindInParam(r, this.serverParams[r].type, v), 
                    d = e, b = r, [ 4, j2db_1.J2DB.fromReadable(i.val, this.bindParams[r], this.connection) ]) : [ 3, 22 ];

                  case 21:
                    return d[b] = t.sent(), [ 3, 23 ];
                  ...
                  case 24:
                    return this._checkBindParameters(e), [ 2, e ];
                }
            });
        });
    }, t.prototype.genOutParamDatas = function() {
        return __awaiter(this, void 0, void 0, function() {
            var e, r, i, s, n;
            return __generator(this, function(t) {
                switch (t.label) {
                  ...
                  case 1:
                    ...
                    this.bindParams[r].ioType !== parameter_1.Parameter.IO_TYPE_OUT && this.bindParams[r].ioType !== parameter_1.Parameter.IO_TYPE_INOUT ? [ 3, 3 ] : (n = (s = e).push, 
                    [ 4, db2j_1.DB2J.toNaturalJS(i, this.bindParams[r], this.connection) ])) : [ 3, 4 ];

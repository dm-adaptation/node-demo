...
var execute_1 = require("./execute"), msg_1 = require("./msg"), error_1 = require("../../driver/error"), const_1 = require("../../desc/const"), dbtype_1 = require("../../driver/dbtype"), ExecDirect = function(o) {
    function t(t, r, e, i) {
    ...
    return __extends(t, o), t.prototype.te = function() {
        ...
        try {
            for (var c = __values(this.rr), f = c.next(); !f.done; f = c.next()) {
                if (null === (u = f.value).bytes) this.mt.Tn(const_1.Const.DATA_NULL_LEN); else {
                    if (u.bytes.length > const_1.Const.MAX_PARAM_DATA_LEN) {
                        if (this.nr.at.msgVersion >= msg_1.Msg.VERSION_PARAMETER_DATA_LEN_4 && u.bytes.length < 4294967295 && dbtype_1.DBType.isComplexType(u.type, u.scale)) {
                            this.mt.m(const_1.Const.DATA_FULL_LEN), this.mt.Ln(u.bytes);
                            continue;
                        }

...
var buffer_1 = require("../buffer"), error_1 = require("../../driver/error"), const_1 = require("../../desc/const"), events_1 = require("events"), timer_1 = require("../../utils/timer"), Msg = function(_) {
    function M(t, s, i, n) {
        ...
        return r.nr = t, r.mt = new buffer_1.DmBuffer(M.Rs), r.Qt = s, r.fs = 0, r.ir = i, 
        r._callback = n, r._timeout = t.at.conn_prop_socketTimeout, r._timer = new timer_1.Timer(function() {
            r.emit("timeout");
        }), r;
    }
    return __extends(M, _), M.prototype.Bt = function() {
        ...
        if (this.fs = this.mt.t(M.Mi), this.fs < 0) {
            if (this.fs !== error_1.DBError.EC_RN_EXCEED_ROWSET_SIZE().errCode) throw new error_1.DBError(this.fs, (this.nr.at.rwStandby ? "[S] " : "") + this.Ci());
        } else 0 < this.fs || this.Qt !== M.Vt && this.Qt !== M.Ms || this.Ci();
    }, M.prototype.Ci = function() {
        var t = this.nr.at.getServerEncoding();
        return t && 1 !== this.nr.at.conn_prop_locale && t === const_1.Const.ENCODING_EUCKR && (t = const_1.Const.ENCODING_GB18030), 
        this.mt.$t(this.mt.N(), !1, !0), this.mt.$t(this.mt.N(), !1, !0), this.mt.$t(this.mt.N(), !1, !0), 
        this.mt.Pn(t);
    }, M.prototype.kt = function() {
        var t, s;
        this.nr.st ? (t = this.dt(), this.yt(t + M.Di), s = this.Ei(this.mt, 0, M.lt + t), 
